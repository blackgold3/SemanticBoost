    ...
    def __init__(
        ...
        **kwargs
        ...
        try:
            ...
            curr_path = model_path.replace("smplh", "")
            handleft_dir = os.path.join(curr_path, "mano")
            with open(os.path.join(handleft_dir, "MANO_LEFT.pkl"), 'rb') as smplh_file:
                handleft = pickle.load(smplh_file, encoding='latin1')  
            with open(os.path.join(handleft_dir, "MANO_RIGHT.pkl"), 'rb') as smplh_file:
                handright = pickle.load(smplh_file, encoding='latin1')         

            setattr(data_struct, "hands_componentsl", handleft["hands_components"])  
            setattr(data_struct, "hands_componentsr", handright["hands_components"])            
            setattr(data_struct, "hands_meanl", handleft["hands_mean"])  
            setattr(data_struct, "hands_meanr", handright["hands_mean"])     
